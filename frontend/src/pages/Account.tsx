  ...
  return (
    <div className="mx-auto max-w-lg px-4 pb-24 pt-8">
      <div className="flex flex-col gap-6">
        ...
        {/* Account info */}
        <div className="rounded-2xl bg-card p-4 shadow-sm flex flex-col gap-3">
        ...
        {/* Anonymous mode */}
        <div className="rounded-2xl bg-card p-4 shadow-sm flex items-start gap-3">
        ...
        {/* Change password */}
        <div className="rounded-2xl bg-card p-4 shadow-sm flex flex-col gap-4">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 rounded-2xl bg-muted px-4 py-3 text-sm font-medium text-foreground hover:bg-muted-foreground/10 transition-colors"
        >
